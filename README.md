  ...
  <div class="container">
    ...
    <nav>
      <ul>
        ...
        <li><a href="https://yjc-001.github.io/.github.io/风阅.html">风阅<span class="small-font">（网页模板）</span></a></li>
      </ul>
    </nav>
  </div>
</header>
<section class="profile" id="profile">
  ...
  <div class="container">
    ...
    <p>我是一个出生于2000年5月10号的男生，热爱计算机和人工智能相关的领域。我喜欢蓝色，它给我一种宁静和平和的感觉。在我的业余时间，我喜欢爬山和旅游，这让我能够放松身心，同时也能欣赏大自然的美景。
      ...
      我对电脑相关的内容非常感兴趣，并且已经坚持自学了一年多。我目前比较熟悉Python编程语言，能够使用简单的爬虫技术来获取网页数据。此外，我还能制作一些小游戏，并具备一定的Web前端开发能力。我还熟悉使用ps和pr等软件，可以进行简单的图像和视频编辑。

      我对人工智能领域也有浓厚的兴趣，我希望能够深入学习和研究这个领域的技术和应用。我相信通过不断学习和实践，我能够在计算机行业中取得更多的成就。

      由于我一直以来都是完全自学，并且没有任何专业人士指导，仅仅依靠着从网络和书本上慢慢积累的知识来一步一步的实现我心中对于电脑与网络技术的想象，这是一件非常漫长与痛苦的过程。所以，我创建了这个网站，旨在与给想要入行的新手提供经验，以及解答所遇到的难题。由于是我个人搭建，难免有所欠缺与遗漏。若是有什么好的建议与意见，请联系本人修改，本网站将会持续更新。</p>
    <p>技能：</p>
